...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1><i class="fa fa-exchange"></i> New Transactions</h1>
                      ...
                      <div id="student">
                          ...
                          <div class="form-horizontal">
                              <div class="form-group row">
                                  ...
                                  <div class="col-md-8">
                                      <input placeholder="Contact number" class="form-control" type="text" name="contact">
                                  </div>
                              </div>
                          </div>
                      </div>
                      <div id="faculty">
                          <div class="form-horizontal">
                              <div class="form-group row">
                                  <label class="control-label col-md-3">Name</label>
                                  <div class="col-md-8">
                                      <input class="form-control" type="text" placeholder="Name" name="f_name">
                                  </div>
                              </div>
                          </div>
                          <div class="form-group row">
                            ...
                            <div class="form-horizontal">
                              <div class="form-group row">
                                  ...
                                  <div class="col-md-8">
                                      <input class="form-control" type="text" placeholder="Position" name="f_position">
                                  </div>
                              </div>
                            </div>
                          ...
                          <div class="form-horizontal">
                              <div class="form-group row">
                                  <label class="control-label col-md-3">Address</label>
                                  <div class="col-md-8">
                                      <input class="form-control" placeholder="Address" type="text" name="f_address">
                                  </div>
                              </div>
                          </div>
                          <div class="form-horizontal">
                              <div class="form-group row">
                                  <label class="control-label col-md-3">Contact Number</label>
                                  <div class="col-md-8">
                                      <input class="form-control" placeholder="Contact Number" type="text" name="f_contact">
                                  </div>
                              </div>
                          </div>
                      </div>
              ...
              <div class="col-md-6">
                  <div class="tile-body">
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-md-8">
                              <input class="form-control" type="text" name="member_id" readonly value="{{ $member_id }}">
                          </div>
                      </div>
                        <div class="form-group row">
