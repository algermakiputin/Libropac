...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1><i class="fa fa-save"></i> Students</h1>
            <p>Library Members</p>
        </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="students-modal">
            ...
            <div class="modal-body">
                ...
                <div class="form-horizontal">
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input class="form-control" id="course" type="text" name="course" placeholder="Course">
                        </div>
                    </div>
                </div>
                <div class="form-horizontal">
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input class="form-control" id="year" type="text" name="year" placeholder="Year">
                        </div>
                    </div>
                </div>
                <div class="form-horizontal">
