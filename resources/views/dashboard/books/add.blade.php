...
<main class="app-content">
    ...
    <div class="tile">
        <form method="POST" action="{{ url('admin/books/insert') }}" id="register_book_form">
          @csrf
          <div class="row">
              <div class="col-md-12">
                  ...
                  <div class="tile-body">
                      <div class="form-horizontal">
                          <div class="form-group row">
                              ...
                              <div class="col-md-8">
                                  <input class="form-control" type="text" required="required" placeholder="Accession No." name="accession_number" value="{{ $accession_num }}" readonly="">
                              </div>
                          </div>
                          <div class="form-group row">
                              <label class="control-label col-md-3">Location Symbol</label>
                              <div class="col-md-8">
                                  <select required="required" class="form-control col-md-12" name="location_symbol" style="width: 100%;" placeholder="Location Symbol">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-8">
                                  <input class="form-control" required="required" type="text" placeholder="Classification" name="classification">
                              </div>
                          </div>
                          <div class="form-group row">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-8">
                                  <input class="form-control" required="required" type="text" placeholder="Author 1" name="author1">
                              </div>
                          </div>
                          <div class="form-group row">
                              <label class="control-label col-md-3">Author 2</label>
                              <div class="col-md-8">
                                  <input class="form-control" required="required" type="text" placeholder="Author 2" name="author2">
                              </div>
                          </div>
                          <div class="form-group row">
                              <label class="control-label col-md-3">Editor</label>
                              <div class="col-md-8">
                                  <input class="form-control" required="required"  type="text" placeholder="Editor" name="editor">
                              </div>
                          </div>
                          <div class="form-group row">
                              <label class="control-label col-md-3">Edition</label>
                              <div class="col-md-8">
                                  <input class="form-control" type="text" required="required" placeholder="edition" name="edition">
                              </div>
                          </div>
                          <div class="form-group row">
                              <label class="control-label col-md-3">Place of Publication</label>
                              <div class="col-md-8">
                                  <input class="form-control" required="required" type="text" placeholder="Place of Publication" name="publication_place">
                              </div>
                          </div>
                          <div class="form-group row">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-8">
                                  <input class="form-control" required="required" type="text" placeholder="Physical Description" name="physical_description">
                              </div>
                          </div>
              ...
              <div class="col-md-6">
                  <div class="tile-body">
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-md-8">
                              <input class="form-control" required="required" type="text" placeholder="ISBN" name="isbn">
                          </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-md-8">
                              <input class="form-control" required="required" type="date" placeholder="Date Encoded" name="date_encoded">
                          </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-md-8">
                              <select name="loaning_period" class="form-control" required="required">
